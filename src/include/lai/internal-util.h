...
#define __FMT /* __attribute__((format(printf, 1, 2))) */
__FMT void lai_debug(const char *, ...);
__FMT void lai_warn(const char *, ...);
__FMT __attribute__((noreturn)) void lai_panic(const char *, ...);
#undef __FMT
