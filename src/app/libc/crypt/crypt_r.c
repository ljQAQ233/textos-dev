...
static char *dummy(const char *key, const char *setting, char *output)
{
    return "*";
}
__alias(dummy, __crypt_md5);
__alias(dummy, __crypt_blowfish);
__alias(dummy, __crypt_sha256);
__alias(dummy, __crypt_sha512);
